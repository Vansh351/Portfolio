...
function ContactForm() {
  ...
  const handleSendMail = async (e) => {
    ...
    const requiredError = !userInput.email || !userInput.message || !userInput.name;
    const emailError = !isValidEmail(userInput.email);

    setError({ required: requiredError, email: emailError });
